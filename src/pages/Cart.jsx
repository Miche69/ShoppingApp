...
export default function Cart() {
    ...
    return theme === "light" ? (
        <div className="cart-page p-4 min-h-screen">
            ...
            {products && products.length > 0 && (
                <div className="flex items-start gap-5">
                    ...
                    <div className="flex flex-col h-auto border flex-2 w-full rounded-xl p-4 border-neutral-300">
                        <p className="text-lg font-bold border-b border-b-neutral-300 pb-3 ">Total</p>
                        <div className="pb-3 pt-3 border-b border-neutral-300">
                        ...
                        <div>
                            <button className="bg-indigo-500 w-full text-white p-2 rounded-xl">Checkout</button>
        ...
        <div className="cart-page bg-neutral-900 min-h-screen text-neutral-300 p-4">
            <h1 className="text-3xl font-bold mb-3">Shopping Cart</h1>
            {products && products.length > 0 && (
                <div className="flex items-start gap-5">
                    ...
                    <div className="flex flex-col h-auto border flex-2 w-full rounded-xl p-4 border-neutral-700">
                        <p className="text-lg font-bold border-b border-b-neutral-700 pb-3 ">Total</p>
                        <div className="pb-3 pt-3 border-b border-b-neutral-700">
                            <div className="flex justify-between">
                                <p className="font-semibold">Total: </p>
                                <p className="font-semibold">${(totalPrice).toFixed(2)} </p>
                            </div>
